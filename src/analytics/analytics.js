...
const totalNumberResults = document.querySelector(
  '.text__total-number-results'
);
const numberResultsHeaders = document.querySelector(
  '.text__number-results-headers'
);
...
numberResultsHeaders.textContent = getNumberResultsArticle(
  query,
  articles,
  FIELD_TITLE
);
