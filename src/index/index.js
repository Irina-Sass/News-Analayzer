...
import { PAGE_SIZE, LANGUAGE, SORT_BY, API_KEY, CARDS_FOR_VIEW, NOTHING_FOUND_TITLE, NOTHING_FOUND_TEXT, ERROR_TITLE, ERROR_TEXT } from '../js/constants/indexConstants.js';
import { NEWS_DAYS_DEPTH, DATA_STORAGE_ARTICLES_KEY, DATA_STORAGE_QUERY_KEY } from '../js/constants/commonConstants.js';
...
const searchInput = new SearchInput(form, elementInput, buttonSubmit, searchNews);
...
function searchNews(keyword) {
    ...
    newsCardList.clear();
    newsApi.getNews(keyword, dateTo, dateFrom, PAGE_SIZE, LANGUAGE, SORT_BY)
        .then(data => {
